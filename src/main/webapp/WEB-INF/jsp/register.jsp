							...
							<div style="padding: 100px 100px 10px;">
								...
								<form class="bs-example bs-example-form" role="form"
									...
									<div class="input-group">
										<input type="text" required="required" class="form-control" maxlength="32" placeholder="用户名"
											name="uname" />
									</div>
									...
									<div class="input-group">
										<input type="text" required="required" class="form-control" maxlength="64" placeholder="邮箱"
											name="email" />
									</div>
									...
									<div class="input-group">
										<input type="text" required="required" class="form-control" maxlength="32" placeholder="密码"
											name="password" />
									</div>
